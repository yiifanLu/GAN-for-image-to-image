...
def read_img_GIGAN_version(path):
...
def load_feature_GIGAN_version(path,path_dir):
    
    
    dirName,fileName = os.path.split(path)
    
    #$print()
    color_path = join(path_dir,'direct',fileName)
    normal_path = join(path_dir,'normal',fileName)
    depth_path = join(path_dir,'depth',fileName)
    texture_path = join(path_dir,'albedo',fileName)


    res_tuple = ()
    color = read_img_GIGAN_version(color_path)
    normal = read_img_GIGAN_version(normal_path)
    depth = read_img_GIGAN_version(depth_path)
    texture = read_img_GIGAN_version(texture_path)
    res_tuple = (color,texture, normal, depth)     

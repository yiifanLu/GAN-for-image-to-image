# -*- coding: utf-8 -*-
"""
Created on Fri Feb 28 12:47:00 2020
...
parser.add_argument('-opt', type=str, default='test_seperate_denoiser_diffuse.json', help='Path to options JSON file.')
...
# =============================================================================
    ...
    for data in test_loader:
        ...
        save_DENOISED_img_path = os.path.join(img_dir, '{:d}denoised.png'.format(idx))
        save_NOISY_img_path = os.path.join(img_dir, '{:d}noisy.png'.format(idx))
